...
frozen = load("vendor_frozen_download", "src/wolfi/vendor-artifacts/scripts/prefetch-frozen.py")
resolver = load("vendor_mutable_download", "src/wolfi/vendor-artifacts/scripts/resolve-vendor.py")
apk = load("apk_supply_download", "src/wolfi/apk-artifacts/scripts/supply_lib.py")
